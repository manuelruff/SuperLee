...
class WorkerTest {
    ...
    void getShiftWorked() {
        ...
        tester.AddShift(Days.Monday);
        tester.AddShift(Days.Thursday);
        assertEquals(6,tester.getShiftWorked());
        tester.ResetDaysOfWork();
        tester.AddShift(Days.Sunday);
        tester.AddShift(Days.Monday);
        tester.AddShift(Days.Thursday);
        ...
        assertEquals(12,tester.getShiftWorked());
        tester.ResetShiftsAmount();
        assertEquals(0,tester.getShiftWorked());
    }
    ...
    void getWage() {
        Worker tester = new Worker("manu" , " 1", 318 , "ata ahla gever",130, Jobs.ShiftManager ,"123" );
        assertEquals(130,tester.getWage());
    }
    ...
    void setWage() {
        ...
        assertEquals(130,tester.getWage());
        tester.setWage(1000);
        assertEquals(1000,tester.getWage());
    }

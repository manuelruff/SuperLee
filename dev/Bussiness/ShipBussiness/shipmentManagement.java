...
import Bussiness.HRBussiness.Driver;
...
public class shipmentManagement {
     ...
     */
    public void addDriver(String ID,String Name,  int Bank,String Contract, double Wage , String Password, char license, int train) {
        Driver driver = new Driver(ID, Name, Bank, Contract, Wage, Password, license, Training.values()[train]);
        drivers.add(driver);
    }
